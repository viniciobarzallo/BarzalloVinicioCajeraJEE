...
a persistence unit "BarzalloVinicioCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BarzalloVinicioCajeraJEE\pom.xml":
...
artifact ("BarzalloVinicioCajeraJEE.war") is already built. You can build
